...
class student
{
    int rollno;
    char name[50];
    int eng_marks, math_marks, sci_marks, univ_marks, hst_marks;
    double average;
    char grade; 
...
{
    average=(eng_marks+math_marks+sci_marks+univ_marks+hst_marks)/5.0;
    if(average>90)
    grade='A';
    else if(average>=75)
    grade='B';
